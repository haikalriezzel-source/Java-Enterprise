...
<%
    request.setAttribute("pageTitle", "Available Facilities");
    request.setAttribute("pageSubtitle", "Search and book facilities for your activities.");
        ...
        <main class="student-content">
            ...
            <div class="student-card card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<%=request.getContextPath()%>/facilityList" method="get">
                            ...
                            <tbody>
                                ...
                                %>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= facility.getOpenTime() %></td>

                                        <td><%= facility.getCloseTime() %></td>

                                        <td>
                                            <span class="badge badge-student-success rounded-pill">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-student-primary"
                                               href="<%=request.getContextPath()%>/student/bookingFacility.jsp?facilityID=<%=facility.getFacilityID()%>">
                                                Book
                                            </a>
                                        </td>
