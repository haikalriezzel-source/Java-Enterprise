...
<%
    request.setAttribute("pageTitle", "Book Facility");
    request.setAttribute("pageSubtitle", "Choose your booking date, time and purpose.");
...
<!-- SCRIPT -->
<script>
    document.querySelector('input[name="startTime"]').addEventListener('change', function () {
        document.querySelector('input[name="endTime"]').min = this.value;
    });
</script>
