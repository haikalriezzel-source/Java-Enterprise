...
<nav class="navbar navbar-expand-lg admin-topbar">
    ...
    <div class="container-fluid px-3 px-lg-4">
        ...
        <a class="navbar-brand d-flex align-items-center gap-2"
           href="<%=request.getContextPath()%>/dashboardAdmin">
        ...
        <div class="collapse navbar-collapse" id="adminTopNav">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-1">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<%=request.getContextPath()%>/admin/addFacility.jsp">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="<%=request.getContextPath()%>/admin/addEquipment.jsp">
                                <i class="fa-solid fa-plus"></i>
                                Add Equipment
                            </a>
                        </li>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a class="btn btn-admin-soft btn-sm"
                   href="<%=request.getContextPath()%>/EditAdminProfileServlet">
